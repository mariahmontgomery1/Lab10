...
\begin{lstlisting}[style=Verilog,caption=Show 2's Compliment ,label=show_2c.sv]
module show_2c(
	input [7:0] Din,
	output [15:0] Dout,
	output sign
...
\begin{lstlisting}[style=Verilog,caption=Show 2's Compliment Test,label=show_2c_test.sv]
module show_2c_test();
